...
import org.example.spring_theory.ch01.ex_1_6.dao.DConnectionMaker;
import org.example.spring_theory.ch05.ex_5_2.dao.RowMapper;
import org.example.spring_theory.ch05.ex_5_2.dao.StatementStrategy;
...
public class JdbcContext {
    ...
    public void workWithStatementStrategy(StatementStrategy statementStrategy) throws SQLException, ClassNotFoundException {
        ...
        try (
            ...
            DataSourceUtils.releaseConnection(conn, dataSource); // 트렌젝션 커넥션이면 닫지 않음
        }
    }
