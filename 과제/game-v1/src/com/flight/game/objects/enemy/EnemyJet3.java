...
import static com.flight.game.set.ImagesSet.ENEMY_JET_3;
...
public class EnemyJet3 extends EnemyJet {

    // ================================= 멤버변수 =================================
    private MainFrame mf;
    private EnemyJet3 enemyJet3 = this;
    private EnemyMissile enemyMissile;
    private Vector<EnemyMissile> enemyMissileList;
    private boolean crushCheck2 = false;
    // ================================= 생성자 =================================

    public EnemyJet3( MainFrame mf, UserJet userJet, int x, int y, int w, int h ) {

        System.out.println( "[LOG] :::::::: Enemy Jet3 실행." );
        this.mf         = mf;
        ...
        this.w          = w;
        this.h          = h;
        this.jetImgIcon = new ImageIcon( ENEMY_JET_3 );
        this.life       = 5;
            ...
            public void run() {
                ...
                while ( isMoveStart ) {
                    ...
                    try {
                        ...
                        if ( yPos < 400 ) moveLeft();
                        if ( yPos > 900 || mf.getPlayGround().getAppearCnt() == 10000 ) {

                            System.out.println( "[LOG] :::::::: Enemy Jet3 종료." );
                            isMoveStart = false;
...
//                        shootFire();
    ...
    public void shootMissile() {
        ...
        if ( missileSpeed % 200 == 0 ) {
            ...
            enemyMissile = new EnemyMissile( mf, enemyJet3, userJet, xPos + 10, yPos + 40, 270, 5, 20, 20 );
                ...
                while ( yPos < 900 && yPos > -300 ) {
                    try {
                        ...
                        if ( collision ) {
                            ...
                            mf.getPlayGround().getEnemyJetList().remove( enemyJet3 );
                        ...
                        if ( crushCheck ) {
                            ...
                            enemyJet3.setJetImgIcon( new ImageIcon( EXPLOSION ));
                            enemyJet3.repaint();
                            Thread.sleep(1000);
                        }
                        Thread.sleep(10);
    ...
    public void obejectUpdate(Graphics g) {
        ...
        try {
            ...
            for ( EnemyMissile e : enemyMissileList )
                g.drawImage( e.getMissile2().getImage(), (int) e.getXPos(), (int) e.getYPos(), e.getW(), e.getH(), null );
