...
import static com.flight.game.set.ImagesSet.ENEMY_JET_5;
...
public class EnemyJet5 extends EnemyJet {

    // ================================= 멤버변수 =================================
    private MainFrame mf;
    private EnemyJet5 enemyJet5;
    private EnemyMissile enemyMissile;
    private Vector<EnemyMissile> enemyMissileList;
    private boolean crushCheck2 = false;

    // ================================= 생성자 =================================
    public EnemyJet5( MainFrame mf, UserJet userJet, int x, int y, int w, int h ) {

        System.out.println( "[LOG] :::::::: Enemy Jet5 실행." );
        this.mf         = mf;
        ...
        this.w          = w;
        this.h          = h;
        this.jetImgIcon = new ImageIcon( ENEMY_JET_5 );
        this.life       = 5;
            ...
            public void run() {
                ...
                while ( isMoveStart ) {
                    ...
                    try {
                        ...
                        if ( yPos < 450 ) moveLeft();
                        else moveRight();

                        if ( yPos > 900 || mf.getPlayGround().getAppearCnt() == 10000 ) {

                            System.out.println( "[LOG] :::::::: Enemy Jet5 종료." );
                            isMoveStart = false;
...
//                        shootFire();
    ...
    public void shootMissile() {
        ...
        if ( missileSpeed % 200 == 0 ) {
            ...
            enemyMissile = new EnemyMissile( mf, enemyJet5, userJet, xPos + 10, yPos + 40, 270, 3, 20, 20 );
                ...
                while ( yPos < 900 && yPos > 30 ) {
                    try {
                        ...
                        if ( collision ) {
                            ...
                            mf.getPlayGround().getEnemyJetList().remove( enemyJet5 );
                        ...
                        if ( crushCheck ) {
                            ...
                            enemyJet5.setJetImgIcon( new ImageIcon( EXPLOSION ));
                            enemyJet5.repaint();
                            Thread.sleep(1000);
                        }
                        Thread.sleep(10);
