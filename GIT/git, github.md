...
![[Pasted image 20260604153237.png]]

- staging: 변경 사항 중 버전을 저장할 파일만 골라 임시로 담아두는 것
- commit: 내 컴퓨터(로컬 저장소)에 작업 기록을 저장하는 작업
- push: 로컬 저장소의 내용을 원격 저장소에 업로드, 다른 사람들과 공유하는 것